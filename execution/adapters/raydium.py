...
DIX VISION v42.2 — Raydium Exchange Adapter
...
class RaydiumAdapter(BaseAdapter):
    ...
    def place_order(self, symbol: str, side: str, size: float,
        ...
        append_event("MARKET", "ORDER_PLACED", "raydium", result)
        return result

    def cancel_order(self, order_id: str) -> bool:
        # TODO: implement live order cancellation
        append_event("MARKET", "ORDER_CANCELLED", "raydium",
                     {"order_id": order_id})
        return True
