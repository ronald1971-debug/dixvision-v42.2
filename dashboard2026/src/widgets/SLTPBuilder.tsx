...
const PRESETS: Record<FormKey, Record<PresetKey, Preset>> = {
  ...
  forex: {
    conservative: {
      ...
      timed_minutes: null,
      tp_ladder: [
        { size_pct: 33, trigger_pct: 0 },
        { size_pct: 33, trigger_pct: 0 },
        { size_pct: 34, trigger_pct: 0 },
      ],
      breakeven_after_first_tp: true,
      bracket: true,
      oco: true,
      notes: "SL 10 pips · TP 20/40/80 pips",
    },
    standard: {
      hard_sl_pct: 0,
      trailing_pct: null,
      ...
      bracket: true,
      oco: true,
      notes: "SL 20 pips · TP 40/80/160 pips",
    },
    aggressive: {
      hard_sl_pct: 0,
      trailing_pct: null,
      ...
      bracket: true,
      oco: true,
      notes: "SL 30 pips · TP 60/120/240 pips",
    },
  },
  stocks: {
    conservative: {
