...
class RiskSnapshot:
    ...
    Attributes:
        ...
        symbol_caps: Optional per-symbol overrides for ``max_position_qty``.
        halted: True when governance has halted the hot path (kill-
            switch / SAFE mode); all signals reject.
    """
